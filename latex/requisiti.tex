...
\hline
  \textbf{Scenario Principale} & 1. Login \linebreak 2. Il farmacista può eseguire la verifica, sospendere un account, controllare le prenotazioni \\
\hline
...
\hline
  \textbf{Postcondizioni} & Viene mostrato l'elenco degli Utenti a rischio sospensione\\
\hline
  \textbf{Scenario Principale} & 1. Il Farmacista va nella schermata di visualizzazione utenti \linebreak 2. Il sistema recupera l'elenco degli utenti a rischio o sospesi \linebreak 3. Il sistema mostra a video l'elenco degli utenti\\
\hline
  \textbf{Scenari Alternativi} &\\
\hline
  \textbf{Requisiti non funzionali} & Velocità di ricerca dei dati e semplicità di navigazione tra le diverse maschere\\
...
\begin{tabular} {|P{4.5cm}|P{12.5cm}|}
  ...
  \hline
    \textbf{Scenario principale} & 1. ControlloUtenti \linebreak 2. Il farmacista può sospendere o annullare la sospensione di un utente \\
  \hline
    \textbf{Scenari alternativi} &\\
  \hline
...
\begin{tabular} {|P{4.5cm}|P{12.5cm}|}\hline
  ...
  \hline
    \textbf{Postcondizioni} &\\
  \hline
    \textbf{Scenario Principale} & 1. Il cliente esegue il login \linebreak 2. Il cliente può visualizzare le proprie prenotazioni passate o in corso e può effettuare nuove prenotazioni.\\
  \hline
    \textbf{Scenari Alternativi} &\\
  \hline
...
\hline
  \textbf{Scenario principale} & 1. RicercaFarmaci Scenario Alternativo A \linebreak 2. Il cliente seleziona i farmaci che vuole prenotare, la quantità, e inserisce la data di ritiro desiderata \linebreak 3. Il cliente invia la richiesta di prenotazione \linebreak 4. Il sistema pone la richiesta in attesa di conferma\\
\hline
...
\hline
  \textbf{Scenario Principale} & 1. Login \linebreak 2. Il cliente seleziona l'opzione di visualizzazione della lista delle prenotazioni \linebreak 3. Al cliente viene mostrato l'elenco delle prenotazioni effettuate\\
\hline
  \textbf{Scenari Alternativi} &\\
\hline
  \textbf{Requisiti non funzionali} & Velocità di verifica dei dati e semplicità di navigazione tra le diverse maschere\\
